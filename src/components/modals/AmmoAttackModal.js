...
export default function AmmoAttackModal() {
  ...
  const onSubmitData = (data) => {
    ...
    setWeaponField((weaponField) => {
      return {
        ...weaponField,
        ammoAttacks: weaponField.ammoAttacks.concat({ ...data, id: uuidv4() }),
      };
    });
    onClose();
  };
  ...
  return (
    <>
      <Button width="fit-content" marginTop="2rem" onClick={onOpen}>
        Add Ammo Attack
      </Button>
          ...
          <ModalContent minWidth="75vw" minHeight="60vh">
            ...
            <ModalBody width="75vw" height="60vh">
              <Flex direction="column">
                ...
                />
                <Text fontSize="2xl">
                  Attack speed. ex: 3:3 is the speed of most weapons
                </Text>
                <Input
                  marginTop="1rem"
                  marginBottom="1rem"
